 ...
 //   @Override
   ...
   // }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Prefhelper.getInstance(MainActivity.this).getLoggedIn()) {
            if (Prefhelper.getInstance(MainActivity.this).getUsertype().equals("4")) {
                Intent intent = new Intent(MainActivity.this, Navigation.class);
                intent.putExtra("userid", Prefhelper.getInstance(MainActivity.this).getUserid());
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (message.compareTo("success") == 0) {
                                        ...
                                        Prefhelper.getInstance(MainActivity.this).setLoggedIn(true);
                                        Prefhelper.getInstance(MainActivity.this).setUserid(userid);
                                        Prefhelper.getInstance(MainActivity.this).setUsertype(user_type);
                                        ...
                                        if((loginResponse.getData().getUserType()).compareTo("4")==0) {
                                            ...
                                            Intent intent = new Intent(MainActivity.this, NavigationForDoctor.class);
                                            intent.putExtra("userid", loginResponse.getData().getId());
                                            startActivity(intent);
                                            finish();
