...
public class NavigationForDoctor extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_navigation_for_doctor);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        final NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view);


        final ImageView cover = (ImageView) navigationView.getHeaderView(0).findViewById(R.id.showingDoctorImgId); //get your ImageView
        //load the image into ImageView
        final TextView txtProfileName = (TextView) navigationView.getHeaderView(0).findViewById(R.id.currentdoctorId);
        final TextView txtProfileNameEmail = (TextView) navigationView.getHeaderView(0).findViewById(R.id.doctorEmailId);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (message.compareTo("success") == 0) {
                            ...
                            navigationView.setNavigationItemSelectedListener(NavigationForDoctor.this);
                            Glide.with(NavigationForDoctor.this).load(contactService_getDetails.getData().getAvatar()).into(cover);
...
*/
   ...
   // @Override
    //public boolean onCreateOptionsMenu(Menu menu) {
      ...
      //  getMenuInflater().inflate(R.menu.navigation_for_doctor, menu);
        //return true;
    //}
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_doctordashboard) {
            Intent intent=new Intent(NavigationForDoctor.this,DoctorDashboardActivity.class);
            startActivity(intent);
            // Handle the camera action
        } else if (id == R.id.nav_doc_service) {
            Intent intent=new Intent(NavigationForDoctor.this,ServicesActivity.class);
            startActivity(intent);

        } else if (id == R.id.patMsgtoDoc) {
            Intent intent=new Intent(NavigationForDoctor.this,PatientMessageActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_viewprofile) {
            Intent intent=new Intent(NavigationForDoctor.this,ViewProfileDoctor.class);
            startActivity(intent);

        } else if (id == R.id.nav_share) {

        } else if (id == R.id.nav_send) {
            startActivity(new Intent(NavigationForDoctor.this,MainActivity.class));
            Prefhelper.getInstance(NavigationForDoctor.this).setLoggedIn(false);
            finish();
    ...
    private Request login_request() {
        ...
        try {
            postdata.put("user_id", Prefhelper.getInstance(NavigationForDoctor.this).getUserid());
